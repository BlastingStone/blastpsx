...
local objects = {}
	local themes = {
	Background = Color3.fromRGB(1, 23, 0),
        Glow = Color3.fromRGB(95, 255, 95),
        Accent = Color3.fromRGB(1, 23, 0),
        LightContrast = Color3.fromRGB(11, 44, 12),
        DarkContrast = Color3.fromRGB(1, 23, 0),  
        TextColor = Color3.fromRGB(136, 255, 105)
}
